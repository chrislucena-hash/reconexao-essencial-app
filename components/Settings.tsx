    ...
    <div className="min-h-screen pt-safe pb-safe-nav p-6 space-y-8 animate-in fade-in duration-500">
        ...
        <div className="space-y-3">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h4 className="text-sm font-bold text-white">Instruções do Aplicativo</h4>
                <p className="text-[9px] text-white/40 uppercase tracking-widest">Mandamentos e Ordem de Peregrinação</p>
              </div>
            </div>
            <ChevronRight size={18} className="text-white/20 group-hover:text-white transition-all animate-pulse" />
          </button>
          ...
          <a 
            ...
            className="w-full glass-mystic p-5 rounded-3xl border border-white/5 flex items-center justify-between group hover:border-aura-rose/30 transition-all"
          >
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 bg-aura-rose/10 rounded-xl flex items-center justify-center text-aura-rose">
                <Instagram size={20} />
              </div>
              <div className="text-left">
                <h4 className="text-sm font-bold text-white">Instagram do App</h4>
                <p className="text-[9px] text-white/40 uppercase tracking-widest">@reconexaoessencial.com.br</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h4 className="text-sm font-bold text-white">Instagram da Autora</h4>
                <p className="text-[9px] text-white/40 uppercase tracking-widest">@chrislucenaescritora</p>
              </div>
            </div>
            <ChevronRight size={18} className="text-white/20 group-hover:text-white transition-all" />
          </a>
              ...
              <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar space-y-6 text-xs text-ethereal-200 leading-relaxed italic">
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <p className="text-magic-gold font-bold not-italic uppercase tracking-tighter text-[10px] mb-1">Redes Sociais & Contato</p>
                      <p>Instagram Oficial do App: <a href="https://www.instagram.com/reconexaoessencial.com.br" target="_blank" rel="noopener noreferrer" className="text-white underline font-bold">@reconexaoessencial.com.br</a></p>
                      <p>Instagram da Autora: <a href="https://www.instagram.com/chrislucenaescritora" target="_blank" rel="noopener noreferrer" className="text-white underline font-bold">@chrislucenaescritora</a></p>
                    </div>
      ...
      <section className="pt-4 border-t border-white/5">
        <div className="glass-mystic p-6 rounded-[2.5rem] border border-white/10 text-center space-y-4">
          ...
          <div>
            <h4 className="text-white font-bold">Fale Conosco & Suporte</h4>
          ...
          <div className="space-y-3">
            <a 
              ...
              className="flex items-center justify-center gap-2 w-full bg-white/5 text-magic-gold py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-white/10 transition-all border border-magic-gold/20"
            >
              <Mail size={16} /> reconexaoessencial.br@gmail.com
            </a>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full bg-white/5 text-aura-rose py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-white/10 transition-all border border-aura-rose/20"
            >
              <Instagram size={16} /> @reconexaoessencial.com.br
            </a>
          </div>
        </div>
      </section>

  ...
  return (
    <div className="min-h-[100dvh] px-4 sm:px-6 py-6 pt-safe pb-safe flex flex-col items-center justify-center bg-ethereal-950 text-white animate-in fade-in duration-700 w-full overflow-y-auto">
      ...
      >
        ...
        <div className="glass-mystic p-5 sm:p-6 rounded-[2rem] sm:rounded-[2.5rem] border border-[#18245C]/10 space-y-6 max-h-[22vh] sm:max-h-[25vh] overflow-y-auto custom-scrollbar">
          <div className="space-y-4 text-[11px] sm:text-xs text-[#4A506B] leading-relaxed italic">
            <h3 className="text-xs sm:text-sm font-bold text-[#18245C] not-italic">AVISO DE ISENÇÃO DE RESPONSABILIDADE MÉDICA</h3>

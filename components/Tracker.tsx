...
const Tracker: React.FC<TrackerProps> = ({ onSaveLog, logs, setView }) => {
  ...
  return (
    <div className="p-4 pt-safe pb-safe-nav max-w-2xl mx-auto space-y-12 animate-in fade-in">
      <header className="px-4 text-center">
        <h2 className="text-4xl font-serif text-[#18245C] italic tracking-tighter">Livro de Espelhos</h2>
        <p className="text-[#E9B44C] text-[10px] uppercase tracking-[0.4em] font-black mt-2">Portal do Diário</p>
      </header>

      {/* Notice Banner */}
      <div className="mx-2 p-6 rounded-[2.5rem] bg-[#E9B44C]/10 border border-[#E9B44C]/30 flex items-start gap-4 shadow-md animate-in slide-in-from-top duration-500">
        <AlertTriangle className="text-[#E9B44C] shrink-0 mt-0.5 animate-pulse" size={22} />
      ...
      {/* Date Picker Card */}
      <div className="glass-mystic p-8 rounded-[3rem] border border-[#18245C]/10 mx-2 flex justify-between items-center shadow-xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <span className="text-[10px] font-black uppercase text-[#4A506B] tracking-widest block mb-1">Ciclo de Consciência:</span>
            <span className="text-[#18245C] font-serif text-xl italic">{new Date(date + 'T00:00:00').toLocaleDateString('pt-BR', { day: '2-digit', month: 'long', year: 'numeric' })}</span>
          </div>
        </div>
        <div className="relative">
          ...
          <div className="p-4 bg-[#18245C]/5 rounded-2xl border border-[#18245C]/10 text-magic-gold shadow-md hover:bg-[#18245C]/10 transition-colors"><Edit3 size={20} /></div>
        </div>
      </div>
      ...
      <div className="space-y-10 px-2">
        ...
        <section className="glass-mystic p-10 rounded-[4rem] border border-aura-teal/20 space-y-8 shadow-2xl relative overflow-hidden">
           ...
           <div className="text-center space-y-2">
              <h3 className="font-serif text-3xl text-[#18245C] italic tracking-tight">Recordatório do Templo</h3>
           ...
           <div className="grid grid-cols-1 gap-6">
              <div className="space-y-3">
                <div className="flex items-center gap-2 ml-4">
                  <Coffee size={14} className="text-[#E9B44C]" />
                  <label className="text-[10px] font-black uppercase tracking-widest text-[#18245C]/80">Primeira Alquimia (Desjejum)</label>
                </div>
                <input 
                  type="text"
                  value={breakfast}
                  ...
                  className="w-full bg-white/80 border border-[#18245C]/15 rounded-2xl p-4 text-xs text-[#18245C] italic placeholder:text-[#4A506B]/60 focus:border-[#E9B44C] outline-none shadow-sm"
                />
              </div>

              <div className="space-y-3">
                <div className="flex items-center gap-2 ml-4">
                  <Sun size={14} className="text-[#E9B44C]" />
                  <label className="text-[10px] font-black uppercase tracking-widest text-[#18245C]/80">Grande Alimento (Almoço)</label>
                </div>
                <input 
                  type="text"
                  value={lunch}
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2 ml-4">
                  ...
                  <label className="text-[10px] font-black uppercase tracking-widest text-[#18245C]/80">Repouso do Templo (Jantar)</label>
                </div>
                <input 
                  type="text"
                  value={dinner}
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2 ml-4">
                  ...
                  <label className="text-[10px] font-black uppercase tracking-widest text-[#18245C]/80">Interlúdios (Lanches)</label>
                </div>
                <input 
                  type="text"
                  value={snacks}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-6 bg-aura-teal/10 rounded-3xl border border-aura-teal/20 flex flex-col items-center gap-4">
                  ...
                  <div className="flex items-center gap-6">
                    <button onClick={() => setWaterGlasses(Math.max(0, waterGlasses - 1))} className="p-2 bg-[#18245C]/10 rounded-full text-[#18245C] hover:bg-[#18245C]/20"><Minus size={16} /></button>
                    <div className="text-center">
                      <span className="text-3xl font-serif text-[#18245C]">{waterGlasses}</span>
                      <span className="text-[10px] text-[#4A506B] block uppercase font-bold">Copos</span>
                    </div>
                    <button onClick={() => setWaterGlasses(waterGlasses + 1)} className="p-2 bg-[#18245C]/10 rounded-full text-[#18245C] hover:bg-[#18245C]/20"><Plus size={16} /></button>
                  </div>
                </div>
                ...
                <div className="p-6 bg-aura-violet/10 rounded-3xl border border-aura-violet/20 flex flex-col items-center gap-4">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-center">
                      <span className="text-3xl font-serif text-[#18245C]">{fastingHours}</span>
                      <span className="text-[10px] text-[#4A506B] block uppercase font-bold">Horas</span>
                    </div>
                    <button onClick={() => setFastingHours(Math.min(24, fastingHours + 1))} className="p-2 bg-[#18245C]/10 rounded-full text-[#18245C] hover:bg-[#18245C]/20"><Plus size={16} /></button>
                  </div>
                </div>
              </div>
           </div>
        ...
        <section className="space-y-8">
           <div className="space-y-4">
              <div className="flex items-center gap-2 ml-4">
                <CloudLightning size={14} className="text-[#E9B44C]" />
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E9B44C]">Emanações da Alma</label>
              </div>
              <textarea 
                className="w-full bg-white/80 border border-[#18245C]/15 rounded-[2.5rem] p-8 text-sm text-[#18245C] focus:border-[#E9B44C] outline-none resize-none placeholder:text-[#4A506B]/60 italic leading-relaxed shadow-sm transition-all"
           ...
           <div className="space-y-4">
              <div className="flex items-center gap-2 ml-4">
                ...
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-600">Teia de Sincronicidades</label>
              </div>
              <textarea 
                className="w-full bg-white/80 border border-[#18245C]/15 rounded-[2.5rem] p-8 text-sm text-[#18245C] focus:border-indigo-500 outline-none resize-none placeholder:text-[#4A506B]/60 italic leading-relaxed shadow-sm transition-all"
           ...
           <div className="space-y-4">
              <div className="flex items-center gap-2 ml-4">
                <Moon size={14} className="text-rose-600" />
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-rose-600">Observações de Sombra</label>
              </div>
              <textarea 
                className="w-full bg-white/80 border border-[#18245C]/15 rounded-[2.5rem] p-8 text-sm text-[#18245C] focus:border-rose-400 outline-none resize-none placeholder:text-[#4A506B]/60 italic leading-relaxed shadow-sm transition-all"
        ...
        {setView && (
          <NextStepGuide 
            currentStepName="Portal do Diário"
            stepNumber={3}
            totalSteps={7}
